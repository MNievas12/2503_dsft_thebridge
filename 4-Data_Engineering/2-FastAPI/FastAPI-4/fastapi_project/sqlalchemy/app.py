...
from fastapi_project.sqlalchemy import schemas
from fastapi_project.sqlalchemy.database import create_all_tables, get_async_session
from fastapi_project.sqlalchemy.models import Post


# the schema is created when the application starts
